...
data_root = '/truba/home/feyavuz/ranksortloss/aLRPv2-aLRPLossv2/data/lvis_v1/'
img_norm_cfg = dict(
...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='SGD', lr=6e-3, momentum=0.9, weight_decay=5e-4)

...
from mmdet.core import (anchor_inside_flags, build_assigner, build_sampler,
                        ...
                        reduce_mean, unmap, vectorize_labels, bbox_overlaps)
...
class RankBasedATSSHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(RankBasedATSSHead, self).__init__(num_classes, in_channels, **kwargs)
        ...
        if rank_loss_type == 'RankSort':
            ...
            self.SB_weight = 50
            self.period = 7330
            self.ranking_weighting=ranking_weighting
    ...
    def loss(self,
        ...
        all_bbox_targets=[]
        all_bbox_preds=[]
        for anc, labels, label_weights, cls_score, bbox_targets, bbox_pred in zip(anchor_list, labels_list, label_weights_list,cls_scores, bbox_targets_list, bbox_preds):
